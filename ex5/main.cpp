...
class Car {
    ...
    int    get_MaxSeating() const { return m_MaxSeating; }
    int    get_Price()      const { return m_price;      }
    string get_DriveMode() const { return m_DriveMode; }
};
...
int main() {
    ...
    cout << car_1.m_brand<< " : Drive Mode = " << car_1.get_DriveMode() << '\n';

    AUDI_Car car_2("A1",  2023, 5);
    cout << car_2.m_brand<< " : Drive Mode = " << car_2.get_DriveMode() << '\n';

    BENZ_Car car_3("C300", 2023, 5);
    cout << car_3.m_brand<< " : Drive Mode = " << car_3.get_DriveMode() << '\n';
